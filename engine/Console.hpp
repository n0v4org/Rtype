  ...
  public:
    ...
    ~Console() = default;
            ...
            while (1) {
                {
                    ...
                    if (input == "help")
                        ...
                        std::cout << "Command \"" << input << "\" unknown type \"help\" to display all commands." << std::endl;
                }
            }
        }
        ...
        void help() {
            ...
            std::cout << "\tdebug [on | off] -> Turn on or off debug log." << std::endl;
        ...
        void debug(const std::string &turn) {
            if (turn == "on")
                ...
                std::cout << "[DEBUG]: argument \"" << turn << "\" unknown, must be \"on\" or \"off\"." << std::endl;
        }
