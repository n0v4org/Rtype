...
class registry {
    public:
        ...
        sparse_array<Component> &register_component() {
            ...
            _deleteFunctions[std::type_index(typeid(Component))] = [](registry &reg, entity_t const &entity) {
        ...
        typename sparse_array<Component>::reference_type add_component(entity_t const &to, Component const &c) {
    ...
    private:
        ...
        std::unordered_map<std::type_index, std::function<void(registry&, entity_t const &)>> _deleteFunctions;
